# Agent setup for `learn-tanstack-start`

This is a deepsec scanning workspace. Project `learn-tanstack-start` was just registered
(target: `..`). Setup is incomplete — `data/learn-tanstack-start/INFO.md`
...
2. **Fill in `data/learn-tanstack-start/INFO.md`.** It's auto-injected into the AI
...
```bash
bun deepsec scan    --project-id learn-tanstack-start
bun deepsec process --project-id learn-tanstack-start
```
