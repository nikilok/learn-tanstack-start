/**
 * Chromium brand logo — the Chrome mark in monochrome blue shades. Generic
 * fallback for Chromium forks we don't ship a dedicated icon for. `aria-hidden`;
 * sized via `className`.
 */
export default function ChromiumIcon({ className }: { className?: string }) {
  return (
    <svg
