 ...
 * version downloaded and ready; clicking it restarts into the update. Renders
 * nothing on the web and on older shells without the update bridge.
 */
export default function DesktopUpdateToast() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 left-4 z-50 w-64 animate-[update-toast-in_240ms_ease-out] cursor-pointer rounded-xl border border-(--line) bg-(--bg-base) px-4 py-3 shadow-lg transition-shadow duration-200 hover:shadow-xl"
