...
export default function Footer() {
  ...
  return (
    <footer className="site-footer relative mt-24 px-4 pt-14 pb-12">
      ...
      <div className="page-wrap flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-(--chip-line) bg-(--chip-bg) text-(--sea-ink-soft) no-underline transition hover:-translate-y-0.5 hover:border-(--sea-ink-faint) hover:text-(--sea-ink)"
          >
