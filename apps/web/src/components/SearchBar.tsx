        ...
        createPortal(
          ...
          >
            <button
              ...
              className="shadow-ring inline-flex max-w-full items-center gap-2 rounded-full px-3 py-1.5 text-sm text-(--sea-ink-soft) transition hover:bg-(--link-bg-hover) hover:text-(--sea-ink) focus:outline-none"
            >
