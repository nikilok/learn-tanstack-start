  ...
  return (
    <main className="page-wrap mx-auto max-w-2xl px-4 py-12 text-(--sea-ink) [&_a]:text-(--link-blue) [&_h1]:text-3xl [&_h1]:font-bold [&_h2]:mt-8 [&_h2]:text-xl [&_h2]:font-semibold [&_li]:mt-2 [&_li]:leading-relaxed [&_p]:mt-3 [&_p]:leading-relaxed [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6">
      ...
      <ul>
        ...
        <li>
          <strong>Site protection cookie.</strong> A first-party cookie holds a
          random identifier that tells one browser session from another. We keep
          a record of the pages a session viewed and when, so we can measure
          typical usage and protect the service against automated abuse. The
          identifier is not linked to you and is not used for advertising or
          profiling. The cookie expires after 30 days.
        </li>
        <li>
